...
class MedicationListPage extends StatefulWidget {
  ...
  @override
  State<MedicationListPage> createState() =>
      _MedicationListPageState();
}

class _MedicationListPageState
    extends State<MedicationListPage> {
      ...
      child: Column(
        children: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const FavoritesPage())),
